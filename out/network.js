import { backwards, findError, forwards } from "./netFunctions.js";
export class Network {
    ...
    learningCoefficient = 0.05;
    neurons = [];
    connections = [];
    constructor() {
        this.Activator = "sigmoid";
    }
    createNetwork(neuronsCount, addShifting = true) {
        if (neuronsCount.length < 2)
            throw new Error("neuronsCount.length must be at least two");
        this.neurons = [];
        this.connections = [];
